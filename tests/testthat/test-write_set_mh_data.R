...
test_that("error about overwriting data shows", {
    ...
    expect_error(write_set_mh_data(df, dest_folder = "C:/Users/lfeher/OneDrive - DOI/NCBN SETr/NCBN SETr/tests/testthat/testdata"), "Saving data in the folder provided would overwrite existing data. To automatically overwrite existing data, set overwrite to TRUE.")
})
