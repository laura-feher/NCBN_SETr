...
#'
#' @param data data frame (e.g. `$arm` piece of output from `calc_change_cumu()`) with one row per faceting variable, and the following columns, named exactly: event_date_UTC, set_id, SET_direction, mean_cumu. `mean_cumu` should be an already-calculated field of change since baseline.
